...
# JARVIS'S TALK  ===================================================================================================== JARVIS
def play_sound(mp3_list):
    mp3 = random.choice(mp3_list)
    playsound(mp3)

# JARVIS'S EARS ====================================================================================================== JARVIS
def read_voice_cmd():
    voice_text = ''
    print 'Listing...'
    ...
    while True:
       ...
       # elif ' game' in voice_note:
        ...
        # Thanks
            ...
            static_speech('sorry sir, again i should not do it!')
            print 'Thanks boss'
            start_call()
